  ...
  <div class="post">
    ...
    <div class="posts">
      <ul>
        ...
        <li class="border" style="padding: 5px;">
      ...
      <form action="{{ url('/comments/add') }}" method="post">
        ...
        <input style="width: 100px; padding:10px;font-size:11px;" type="submit" value="Add Comment" class="btn btn-secondary">
      </form>
      @endauth
    </div>
  </div>
